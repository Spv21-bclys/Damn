...
public class ExcelMerger {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Filter data where Salary is "Transaction Missing"
            ...
            writeExcel(filteredData, commonColumn, file1Columns, file2Columns, outputPath);

            System.out.println("Data merged and filtered successfully. Output saved to: " + outputPath);
    ...
    // Writes filtered data to an Excel file
